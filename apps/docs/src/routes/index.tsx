...
function HomePage() {
	return (
		<main className="flex min-h-screen flex-col items-center justify-center gap-6 px-4 text-center">
			<img src="/sundayceo-framework-dark.svg" alt="sundayceo" className="h-8 dark:hidden" />
			<img src="/sundayceo-framework-light.svg" alt="sundayceo" className="hidden h-8 dark:block" />
